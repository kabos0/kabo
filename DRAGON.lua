...
serpent = dofile("./library/serpent.") 
...
if res ~= 200 then
print('\27[0;31mٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴ  \n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
if tonumber(user_id) == tonumber(1816324532) then  
var = true  
elseif tonumber(user_id) == tonumber(1601673092) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'فولتر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "V_O_L_T_E_R")
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './'..bot_id..'.json', '- عدد جــروبات التي في البوت { '..#list..'}')
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝘝𝘖𝘓𝘛𝘌𝘙 .")  
...
send(chat,msg.id_,"\n ❆︙ تم رفع الملف بنجاح وتفعيل الــجــروبات\n ❆︙ ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
...
send(msg.chat_id_, msg.id_," ❆︙ تمت الاذاعه الى *~ "..#list.." ~* جــروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
{{text = '𝘝𝘖𝘓𝘛𝘌𝘙', url="t.me/V_O_L_T_E_R"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '⊱━━━━━☛ 𝚟𝚘𝚕𝚝𝚎𝚛 ☚━━━━━⊰' or text == '⊱━━━━━☛ 𝚟𝚘𝚕𝚝𝚎𝚛 ☚━━━━━⊰' or text == '⊱━━━━━☛ 𝚟𝚘𝚕𝚝𝚎𝚛 ☚━━━━━⊰' or text == '"' then
local Text =[[
تواصل السورس 🧚
]]
keyboard = {} 
...
{
{text = ' ❆ مـــبـــرمــج الــســـورس𐄬   ❆ ', url = "https://t.me/U_X_F"},
},
{
{text = '❆ بــوت تــواصــل فـــولــتــر❆', url = "https://t.me/VOLT3R_bot"},
},
...
{
{text = '❆ بوت تواصل االسورس❆', url = "https://t.me/VOLT3R_bot"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_O_L_T_E_R&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sonight1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❆︙ اصدار سورس فولتر \n ❆︙ الاصدار »{ v 1.5}')
end
...
if text == 'الــجــروبات ❆' and DevSoFi(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❆︙ الــجــروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'كلب نسخه الاحتياطيه ❆' and DevSoFi(msg) then 
GetFile_Bot(msg)
end
...
if text == "تنظيف الــجــروبات ❆" and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'❆︙ لا يوجد جــروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n❆︙ تم ازالة » { '..q..' } جــروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n❆︙ تم ازالة » {'..w..'} جــروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'❆︙  عدد الــجــروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n❆︙  الان عدد الــجــروبات الحقيقي » { '..sendok..' } جــروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❆︙ العضو » ['..result.title_..'](t.me/'..(username or 'V_O_L_T_E_R')..')'
status  = '\n ❆︙ تم ترقيته مطور'
...
usertext = '\n ❆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'V_O_L_T_E_R')..')'
status  = '\n ❆︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❆︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..') \n ❆︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," ❆︙ تمت الاذاعه الى >>{"..#list.."} جــروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ❆︙ تمت الاذاعه الى >>{"..#list.."} جــروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' ❆︙ عذا لا يمكنك وضع معرف جــروب بالاشتراك ')
return false  end
...
send(msg.chat_id_, msg.id_,' ❆︙ تم تغيير صورة الــجــروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' ❆︙ تم تغيير وصف الــجــروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ❆︙ تم حفظ ترحيب الــجــروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," ❆︙ العضو : {["..data.first_name_.."](T.ME/V_O_L_T_E_R)}\n ❆︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❆︙ عذرا » {["..data.first_name_.."](T.ME/V_O_L_T_E_R)}\n ❆︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ❆︙ عدد اعضاء الــجــروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ❆︙ بالتأكيد تم تفعيل الــجــروب')
else
sendText(msg.chat_id_,'\n ❆︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ❆︙ تم تفعيل الــجــروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' ❆︙ تم تفعيل جــروب جديده\n'..
'\n ❆︙ بواسطة {'..Name..'}'..
'\n ❆︙ ايدي الــجــروب {'..IdChat..'}'..
'\n ❆︙ اسم الــجــروب {['..NameChat..']}'..
'\n ❆︙ عدد اعضاء الــجــروب *{'..NumMember..'}*'..
'\n ❆︙ الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' ❆︙ بالتأكيد تم تعطيل الــجــروب')
else
sendText(msg.chat_id_,'\n ❆︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ❆︙ تم تعطيل الــجــروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ❆︙ تم تفعيل الــجــروب')
else
sendText(msg.chat_id_,'\n ❆︙ بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ❆︙ تم تفعيل الــجــروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' ❆︙ تم تعيين عدد الاعضاء سيتم تفعيل الــجــروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
❆-[اهــلا بــيــك فــي ســورس فــولـــتــر اذا كــنــت تــريـد بــوت شــخــصــي كـلــمــنــي ](t.me/V_O_L_T_E_R) ❆
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '❆ بــوت تــواصــل فـــولــتــر❆', url = "https://t.me/Tawasl1bot"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sonight1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'مبرمج السورس' or text == 'مبرمج السورس' or text == 'فولتر' or text == '"' then
local Text =[[


❆-[مـــبـــرمــج ســورس فــولــتــر](t.me/U_X_F) ❆
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'الكابوس ' or text == ' Elkabos' then  
local Text = [[  
⊱━━━ᴅᴠ ᴇʟᴋᴀʙᴏѕ ᴋғѕ ━━━⊰
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'مــبـــرمـج الــســـورس',url="t.me/U_X_F"}},  

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/U_X_F&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"‏ ❆ مره واحد اشترى فراخ..   علشان يربيها فى قفص صدر,
"‏ ❆ واحدة عملت حساب وهمي ودخلت تكلم جوزها منه.. ومبسوطة أوي وبتضحك.. سألوها بتضحكي على إيه؟ قالت لهم أول مرة يقول لي كلام حلو من ساعة ما اتجوزنا..",
...
if text == 'العاب فولتر' or text == 'العاب مسليه' or text == 'العاب متطوره' then  
local Text = [[  
...
{{text = '𝚟𝚘𝚕𝚝𝚎𝚛', url="t.me/V_O_L_T_E_R"}}, 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❆︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..') \n ❆︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❆︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'V_O_L_T_E_R')..') \n ❆︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
usertext = '\n ❆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'V_O_L_T_E_R')..')'
status  = '\n ❆︙ تم الغاء (الحظر-الكتم) عام من الــجــروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Get_info then
local TextS = "\n ❆︙ اهلا بك في متجر ملفات فولتر\n ❆︙ ملفات السورس ↓\nٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎??━━━━━━≫ٴ\n ❆︙ علامة تعني { ✔️ } ملف مفعل\n ❆︙ علامة تعني { ✖ } ملف معطل\n ❆︙ قناة سورس فولتر ↓\n".." ❆︙ [اضغط هنا لدخول](t.me/V_O_L_T_E_R) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❆︙ عذرا الملف لايدعم سورس فولتر \n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,' ❆︙ لا تسطيع استخدام البوت \n  ❆︙ يرجى الاشتراك بالقناه اولا \n  ❆︙ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n ❆︙ وينكم تعالو يريدوكم بالــجــروب \nٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- {[@"..username.."]}\n"
...
st = https.request('https://black-source.tk/BlackTeAM/ImgeInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://black-source.tk/BlackTeAM/kmgalker.php?token='..token..'&url='..photo_id.."&type=photo")
...
send(msg.chat_id_, msg.id_," ❆︙ منشئ الــجــروب » ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
------------------------------------------------------------------------
                                                       الـــكــــابـــوس كــان هـــــــو.🤎
------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❆︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'V_O_L_T_E_R')..')'
status  = '\n ❆︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❆︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext =  \n ❆ العضــو » [ ..data.first_name_.. ](t.me/ ..(data.username_ or  V_O_L_T_E_R ).. ) 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❆︙  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'V_O_L_T_E_R')..')'
status  = '\n ❆︙  الايدي » `'..result.sender_user_id_..'`\n ❆︙  تم تنزيله ادمن من الــجــروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
----------------------------------------- انتهاء كشف المجموعة
if text == 'اعدادات الــجــروب' and Mod(msg) then    
...
' }\n'..' ❆︙  الايدي بالصوره » { '..idph..
' }\n'..' ❆︙  الرفع » { '..setadd..
' }\n'..' ❆︙  الحظر » { '..banm..' }\n\nٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴ\n ❆︙ قناة سورس فولتر ↓\n [☞『 𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 𝙫𝙤𝙡𝙩𝙖𝙧 』☜ .](t.me/V_O_L_T_E_R) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_,' ❆︙ تم ازالة صورة الــجــروب') 
end
return false  
end
...
GetWelcome = ' ❆︙ لم يتم تعيين ترحيب للجــروب'
end 
...
send(msg.chat_id_, msg.id_,' ❆︙ تم تفعيل ترحيب الــجــروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' ❆︙ تم تعطيل ترحيب الــجــروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' ❆︙ تم ازالة ترحيب الــجــروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " ❆︙ لا توجد بوتات في الــجــروب")
else
...
send(msg.chat_id_, msg.id_," ❆︙ تم حفظ قوانين الــجــروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," ❆︙ تم ازالة قوانين الــجــروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❆︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'V_O_L_T_E_R')..')'..'\n ❆︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فولتر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فولتر')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس فولتر🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
if text == "بوت" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'فولتر') 
local DRAGON_Msg = { 
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ❆︙ ليست لدي صلاحية تغير اسم الــجــروب")  
else
sebd(msg.chat_id_,msg.id_,' ❆︙ تم تغيير اسم الــجــروب الى {['..Name..']}')  
end
end,nil) 
end
...
database:set(bot_id.."V_O_L_T_E_R:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."V_O_L_T_E_R:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."V_O_L_T_E_R:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."V_O_L_T_E_R:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"❆︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."V_O_L_T_E_R:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."V_O_L_T_E_R:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فولتر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or فولتر').." غادر" or text == 'بوت غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,' ❆︙ تم مغادرة الــجــروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'فــولـتــر')
send(msg.chat_id_, msg.id_,'اسمي الكيوت ['..Namebot..']or'')
end
...
if text == 'الــجــروبات' then
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' ❆︙ عدد الــجــروبات » {`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'V_O_L_T_E_R')..')'
local iduser = result.sender_user_id_
...
if text==('عدد الــجــروب') and Mod(msg) then  
if msg.can_be_deleted_ == false then 
...
'\n\n ❆︙ عدد رسائل الــجــروب : '..(msg.id_/2097152/0.5)..
'\n\n ❆︙  اسم الــجــروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' ❆︙ عذرا لا استطيع طرد ادمنية الــجــروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' ❆︙ تم طردك من الــجــروب') 
...
send(msg.chat_id_, msg.id_,'⚠| لا اسطيع صيح معرفات الــجــروبات') 
return false  
end
if result.id_ then
send(msg.chat_id_, msg.id_,' ❆︙تــع يـبــنــلــعــرص عــايــزيــنــك😿💓 [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ❆ هــو الــعــلــق ابــن الــخــول دهــو 😂» '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ❆ انــت جـــيــت لــوحــدك يــكــداب😿💞) 
end
end,nil)
else
...
if text and text:match("^(gpinfo)$") or text and text:match("^معلومات الــجــروب$") then
...
if text == 'كشف البوتات' and Manager(msg) then
...
local Text =[[
┍━━━━━☛  ["𝗩𝗢𝗟𝗧𝗘𝗥 𝗞𝗔𝗕𝗢𝗦 "](t.me/V_O_L_T_E_R)☚━━━━━┑
                              [ مبرمج السورس   ](t.me/U_X_F) 
┕━━━━━☛  ["𝗩𝗢𝗟𝗧𝗘𝗥 𝗞𝗔𝗕𝗢𝗦 "](t.me/V_O_L_T_E_R)☚━━━━━┙

[❆قناه السورس](t.me/V_O_L_T_E_R)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝚟𝚘𝚕𝚝𝚎𝚛 ', url="t.me/V_O_L_T_E_R"},
{text = 'مبرمج السورس', url="t.me/U_X_F"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━━━━𝚟𝚘𝚕𝚝𝚎𝚛━━━━━━≫ٴٴ\n❆︙ ➫ .[☞『 𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 𝙫𝙤𝙡𝙩𝙖𝙧 』☜ . ](t.me/V_O_L_T_E_R)➤ ')
end
...
if text ==  "انا مين"  and 
send(msg.chat_id_,msg.id_,  [انت العضو نور عيني 🌝💖](t.me/U440p) ) 
...
send(msg.chat_id_,msg.id_,  [ انت مميز ابن ناس🌝 ](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [ انت المدير قلبي من جوه...❤️](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [انت منشئ قد الدنيا اخرب الروم بقق 😎🏃](t.me/V_O_L_T_E_R) ) 

return false

end
f text ==  "انا مين"  and BasicConstructor(msg) then 

send(msg.chat_id_,msg.id_,  [ انت هنا منشئ اساسي يعني اي حد يزعلك اديلو علي عينو😎💜](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [نت صاحب الخرابه دي عايزك تخرب للدنيا 😎💖](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [انت مطور صغير شويه وهتكبر😎💜](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [انت مطوري التاني حته من قلبي 🌝💗](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [انت بابا حبيبي احسن واحد هنن 🥺💘](t.me/U440p) ) 
...
send(msg.chat_id_,msg.id_,  [خدوني معاكم برايفت والنبي..🥺❤️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [عـلـي كـسـمـك يـعــرص😒..](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [قـلـعـت ارجــع بـكـسك😎🚀](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [جــاي اهــو🏃😎](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [ادــيــلــو عـلـي تــيــزو عــيــل هــكــر 😿](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [بــنــت لــكـبــوس وكـلـحــيـتـو🦄💗](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [اقـمـد مـــن الــقـمــدان يــروحـي..💙🧞‍♂️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_,  [نزل عينك يعسل كدا عيب️🥴❤️](t.me/V_O_L_T_E_R) ) 
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [والنبي حايز اشوف🥺❤️](t.me/U440p) )
...
send(msg.chat_id_,msg.id_,  [هــاي يــوتــقـهه 🌎💘](t.me/U440p) ) 
...
send(msg.chat_id_,msg.id_,   ["وانا كمان بحبك 🥺❤"️](t.me/V_O_L_T_E_R) ) 
...
send(msg.chat_id_,msg.id_,  [مححححح فـبـقق اوتــكــهه🥺❤️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [حــطــو فــتــيــزك 😎♥](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [زي ابــوك يــعـرص 😠😒](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [اجــي فـيــن يـبـنـلـعــرص .💙🧞‍♂️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [ونن كــمــن بـحـبـك...🥺❤️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [مــالــك يــروحــي ...🥺❤️](t.me/V_O_L_T_E_R) )
return false
end
end
endif text then 
...
send(msg.chat_id_,msg.id_,  [بــعــيــد الــشــر عــلــيك يـقــلـــبــي...🥺❤️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [وتــســبــنــي لــمــيــن يــوحــش 🥺💔](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [مـــوت فــيــك يــعــمــري...🥺❤️](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [بــحــبــك مــتــزعــلــيــش....🌎💘](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [محححح كبيره يروحي...😙💞](t.me/V_O_L_T_E_R) )
return false
end
end
end
...
send(msg.chat_id_,msg.id_,  [يـتــي عــلــي الــضـحــكــه...🙈💙](t.me/V_O_L_T_E_R) )
return false
end
end
endif text then 
...
send(msg.chat_id_,msg.id_,  [ابعد يشاذ يبن الـكـلـب ..🙂💛](t.me/V_O_L_T_E_R) )
return false
end
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text =  بوت الحذف ,url="t.me/DTeLebot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token.. /sendMessage?chat_id=  .. msg.chat_id_ ..  &text=  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local notText = 'عــذرا الاوامــر هـــذه تــخــص الادمــن فـقــط ⚠  '
...
local notText = 'عــذرا هــذه الاوامــر للادمــن فــقــط.💛🧸️'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
local Teext =[[
...
local notText = ' عــذرا الاوامــر هـــذه لا تــخــصـك ⚠  ❆'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
return false
end
local Teext =[[
...
{
{text = ' 𝘝𝘖𝘓𝘛𝘌𝘙', url="t.me/V_O_L_T_E_R"},
{text = 'مبرمج السورس', url="t.me/V_O_L_T_E_R"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = ' ??𝘖??𝘛𝘌𝘙', url="t.me/V_O_L_T_E_R"},
{text = 'مبرمج السورس', url="t.me/U_X_F"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فولتر')
